...
Write a function named toTitleCase that takes in an array of strings
 and returns an array of strings with the first character in upper case and the rest as is.
...
const toTitleCase = (arr) => {
  ...
  let retArr = []
  arr.forEach((item)=>{
    retArr.push(item[0].toUpperCase()+item.slice(1))
  })
  return retArr;
};
