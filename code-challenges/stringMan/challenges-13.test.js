...
Write a function named findHappiness that takes 
in an array of strings and returns an array containing
...
const standardizePhoneNumbers = (arr) => {
  ...
  let ret=[]
  arr.forEach((item)=>{
    ret.push(item.substring(1,4)+item.substring(6,9)+item.substring(10));
  })
  return ret;
};
