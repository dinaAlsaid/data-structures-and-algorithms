...
Write a function named templatingWithMustache that uses mustache
 to create the markup templates for each of the characters. 
...
const templatingWithMustache = () => {
  ...
  //   template.find('h3').text(`${item.spouse}`);
  //   template.find('p').text(`${item.house}`);
